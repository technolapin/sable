/* $Id: bddsurfend.c,v 1.1.1.1 2008-11-25 08:01:35 mcouprie Exp $ */
/* 
  ...
  int argc; char **argv; 
{
  ...
  ns = n = 0;
  first_one = 1;
  fd = fopen("bddsurfend.cube.res","w");
...
printf("%x\n", CODK2V(d));
...
#ifdef CARRES
  fd = fopen("bddsurfend.carrex.res","w");
  first_one = 1;
  ...
  first_one = 1;
  fd = fopen("bddsurfend.carrey.res","w");
  ...
  first_one = 1;
  fd = fopen("bddsurfend.carrez.res","w");
