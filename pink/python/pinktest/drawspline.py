...
class drawspline(unittest.TestCase):
    def test_0(self):
        ...
        gold   = pink.cpp.readimage( RESULTS + '/drawspline_spline_l2spline1.pgm')
    ...
    def test_1(self):
        ...
        gold   = pink.cpp.readimage( RESULTS + '/drawspline_spline_l3spline1.pgm')
        self.assertTrue( result == gold )
