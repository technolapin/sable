...
class dilation(unittest.TestCase):
    def test_0(self):
        ...
        gold   = pink.cpp.readimage( RESULTS + '/dilation_b2hebreu_b2_se_5_7.pgm')
    ...
    def test_1(self):
        ...
        gold   = pink.cpp.readimage( RESULTS + '/dilation_g2fish1_b2_se_5_7.pgm')
        self.assertTrue( result == gold )
    ...
    def test_2(self):
        ...
        gold   = pink.cpp.readimage( RESULTS + '/dilation_b3a_b3_se_5_5_7.pgm')
        self.assertTrue( result == gold )
    ...
    def test_3(self):
        ...
        gold   = pink.cpp.readimage( RESULTS + '/dilation_g3a_b3_se_5_5_7.pgm')
        self.assertTrue( result == gold )
