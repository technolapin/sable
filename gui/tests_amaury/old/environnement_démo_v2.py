...
class Fenetre(QWidget) :
    ...
    def __init__(self, parent=None) :
        ...
        self.barreDeScroll1.setMaximum(255) # Défini le nombre de valeurs qu'on peut y parcourir
    ...
    def graph1(self) :
        ...
        self.graphique3D.dessinerGraphique3D([courbe1, courbe2, courbe3]) # Dessine le graphique
